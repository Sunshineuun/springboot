...
ALTER TABLE EXT_COULUMN ADD (EDITOR VARCHAR(500));
...
INSERT INTO EXT_COULUMN (ID, MODULE_ID, HEADER, DATA_INDEX, EDITOR)
VALUES (REPLACE(UUID(), '-', ''), '1', '占用', 'occupy', '{"xtype": "textfield", "allowBlank”: false}');

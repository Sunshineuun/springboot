 ...
 * {@link Ext.data.Store#grouper grouper}
 *
...
Ext.define('Ext.grid.feature.Grouping', {
  ...
  groupRowTpl: [
    ...
    '<div class="',
    Ext.baseCSSPrefix,
    'grid-group-title" style="{[groupTitleStyle]}" {ariaGroupTitleAttr} data-qtip="{[values.isCollapsedGroup ? me.expandTip : me.collapseTip]}">',

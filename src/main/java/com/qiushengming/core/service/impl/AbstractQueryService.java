...
public abstract class AbstractQueryService<T extends BaseEntity>
  ...
  private void initTable() {
    ...
    if (classMap == null || !classMap.isCreateTable()) {
      return;
    }
  ...
  private Page<?> findOnPage(String countSql, String searchSql, Map<String, Object> params,
      Page page) {
    ...
    page.setResult(getDao().queryBySql(getEntityClass(),
        ...
        params, page.getPageSize() * (page.getPageNo() - 1),
        page.getPageSize()));
